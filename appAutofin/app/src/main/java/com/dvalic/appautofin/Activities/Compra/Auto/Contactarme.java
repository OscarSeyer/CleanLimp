...
import com.dvalic.appautofin.databinding.FragmentContactarmeBinding;


public class Contactarme extends UTBaseFragment {
    private String TAG = this.getClass().getSimpleName();
    private IComunicador interfaz;
    private FragmentContactarmeBinding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentContactarmeBinding.inflate(inflater, container, false);
